...
class LeadExport:
    ...
    def _format_lead(self, lead, region, industry, run_id):
        return {
            ...
            "signal_detected": lead.get("signal_detected", ""),
            "signal_confidence_score": lead.get("signal_confidence_score", ""),
            ...
            "pack_fill_stage": lead.get("pack_fill_stage", "strict"),
            "repeat_source_domain": lead.get("repeat_source_domain", ""),
