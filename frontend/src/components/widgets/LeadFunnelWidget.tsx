...
export function LeadFunnelWidget({ snapshot }: LeadFunnelWidgetProps) {
  const data = useMemo(() => {
    ...
    return [
      { stage: "Searched", value: searched, color: "#00ffff" },
      { stage: "Queued", value: queued, color: "#00d4aa" },
      { stage: "Enriched", value: enriched, color: "#00ff00" },
  ...
  return (
    <div className="flex h-full flex-col gap-3 overflow-hidden p-1">
      <div className="flex items-center justify-between">
        ...
        <span className="text-[11px] font-mono text-[#00ff00]">{conversionRate}% top-stage conv.</span>
      </div>
